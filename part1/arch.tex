...
\subsection{Explore compiler workflow}
...
\end{figure}
Lets look into compiler frontend as the first component at the compiler's
workflow. 

\subsection{Frontend}
The primary goal for frontend is the source code conversion to IR. It's worth
mentioning that frontend also transforms the source code into various forms
before it produces the IR.
Frontend will be our primary focus in the book, so we will examine its
components. 
The first component of the frontend is the \lexer
